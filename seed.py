...
def seed_modules():
    modules = [
        ...
        {'id': 6, 'name': 'OCA', 'icon': 'fa-circle', 'description': 'Ordinary Civil Action', 'url': 'cases/oca'},
        {'id': 7, 'name': 'SCC', 'icon': 'fa-circle', 'description': 'Small Claims Cases', 'url': 'cases/scc'},
        ...
        {'id': 11, 'name': 'Wedding Schedule', 'icon': 'fa-ring', 'description': 'For Wedding', 'url': 'schedule/wedding'},
        {'id': 12, 'name': 'Court Schedule', 'icon': 'fa-balance-scale', 'description': 'For Court Schedule', 'url': 'schedule/court'},
